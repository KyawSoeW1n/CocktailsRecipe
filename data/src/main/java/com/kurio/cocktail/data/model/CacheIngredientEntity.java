...
public class CacheIngredientEntity {
    private String idIngredient, strIngredient, ingredientUrl, strDescription, strAlcohol;

    public CacheIngredientEntity(String idIngredient, String strIngredient, String ingredientUrl, String strDescription, String strAlcohol) {
